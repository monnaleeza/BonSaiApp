...
class BonsaiEvents extends Component {
  constructor(props) {
    super(props);
    ...
    let items = Array.apply(null, Array(5)).map((v, i) => {
      return {
        id: i,
        date: '02/20/2020',
        event: 'This is a note summary...',
        detail:
          'This is the detail that appears when you top a Event note summary. It displays the enitre event. You also have the ability to edit or remove the event from this view.',
      };
    });
...
export default connect(mapStateToProps, mapDispatchToProps)(BonsaiEvents);
